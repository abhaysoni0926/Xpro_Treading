            ...
            <div className="lg:flex gap-32">
              <div className="space-y-7">
                ...
                <div className="flex">
                  ...
                  <p className="text-gray-500">{"Xpro Treading"} </p>
                </div>
                <div className="flex">
                  <p className="w-[9rem]">Date Of Birth : </p>
                  <p className="text-gray-500">{"26/09/2003"} </p>
                </div>
                <div className="flex">
              ...
              <div className="space-y-7">
                <div className="flex">
                  ...
                  <p className="text-gray-500">{"shri ram institute of technology, jabalpur"} </p>
                </div>
                <div className="flex">
                  <p className="w-[9rem]">City : </p>
                  <p className="text-gray-500">{"Jabalpur"} </p>
                </div>
                <div className="flex">
                  <p className="w-[9rem]">Postcode : </p>
                  <p className="text-gray-500">{482002} </p>
                </div>
                <div className="flex">
